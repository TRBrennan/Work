:: ###############################################################################################################
:: #							DMS Restart All AppHosts Services
:: #							Author: Tom Brennan
:: #							Client: HMRC
:: #							Date Started: 09/01/2017
:: #							Last Updated Started:  09/01/2017
:: #							Last Updated by: TB
:: #							Information: This script completes full  App Host Services Restart
...
ECHO Starting Application Host Services
:: Starting Application Host services
call startAppHosts.bat
call startxCPCompenents.bat
call startCPSActiveMQ.bat
call startDA.bat
call startDFSRest.bat
