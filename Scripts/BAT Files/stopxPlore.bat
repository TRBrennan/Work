...
for /F "tokens=2 delims==" %%s in ('SET XPLORE.SERVER.HOST.') do (
		...
		call safeServiceStop.bat %%s DmWatchdog-E-xPlore
		call safeServiceStop.bat %%s DmPrimaryDsearch
		call safeServiceStop.bat %%s DmIndexagent
	)
