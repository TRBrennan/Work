...
SET APPLICATION.SERVER.NAME=tomcat-rest-8070
...
for /F "tokens=2 delims==" %%s in ('SET APPLICATION.SERVER.HOST.') do (
	...
	ECHO Stopping and Clearing %%s REST Service
	call safeServiceStop.bat %%s %APPLICATION.SERVER.NAME%
	ECHO DEL DIR \\%%s\%APPLICATION.SERVER.FOLDER.PATH%%APPLICATION.SERVER.NAME%\temp
	RMDIR\\%%s\%APPLICATION.SERVER.FOLDER.PATH%%APPLICATION.SERVER.NAME%\temp /q /s
	ECHO DEL DIR \\%%s\%APPLICATION.SERVER.FOLDER.PATH%%APPLICATION.SERVER.NAME%\work
	RMDIR \\%%s\%APPLICATION.SERVER.FOLDER.PATH%%APPLICATION.SERVER.NAME%\work /q /s
	MKDIR \\%%s\%APPLICATION.SERVER.FOLDER.PATH%%APPLICATION.SERVER.NAME%\work
	MKDIR \\%%s\%APPLICATION.SERVER.FOLDER.PATH%%APPLICATION.SERVER.NAME%\temp
