...
ECHO Stopping Full DMS Stack
:: Stopping Full DMS Stack
call stopFullServices.bat

ECHO Starting Full DMS Stack
:: Starting Full DMS Stack
call startFullServices.bat
