...
cd tomcat-apphost8028\bin
ECHO Uninstalling tomcat-apphost8028
call service.bat uninstall tomcat-apphost8028
ECHO Installing apphost8028
call service.bat install apphost8028
ren tomcat-apphost8028w apphost8028w

cd tomcat-bam8020\bin
ECHO Uninstalling tomcat-bam8020
call service.bat uninstall tomcat-bam8020
ECHO Installing bam8020
call service.bat install bam8020
ren tomcat-bam8020w bam8020w

cd tomcat-bps8021\bin
ECHO Uninstalling tomcat-bps8021
call service.bat uninstall tomcat-bps8021
ECHO Installing bps8021
call service.bat install bps8021
ren tomcat-bps8021w bps8021w
