...
ECHO Uninstalling apphost8028
call service.bat uninstall apphost8028
ECHO Installing cpshost8028
call service.bat install cpshost8028
ren tomcat-apphost8028w cpshost8028w
